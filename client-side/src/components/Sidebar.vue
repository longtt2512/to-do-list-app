<template>
  <div class="w-64 bg-sidebar text-sidebar p-6 flex flex-col h-full">
    <!-- Profile Section -->
    <div class="mb-8">
      <div class="flex items-center mb-4">
        <img src="/src/assets/avatar1.png" class="w-12 h-12 rounded-full object-cover mr-3" alt="Profile" />
        <div>
